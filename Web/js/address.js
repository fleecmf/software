    ...
    $("#aa-list").on("click", "a.defaultAdd", function () {
        ...
        if (s == 0) {
            ...
            $.ajax({
                ...
                url: "http://192.168.199.242:8080/BSMD/updateDefaultAddress.do",
                dataType: "json",
                header: {"Content-Type": "application/json", "Accept": "application/json"},
                success: function (data) {
                    console.log(data);
...
function deleteAddress() {
    $("#aa-list").on("click", "ul li .delete", function () {
        ...
        $.ajax({
            type: "post",
            data: JSON.stringify(x),
            url: "http://192.168.199.242:8080/BSMD/deleteUserAddress.do",
            dataType: "json",
            header: {"Content-Type": "application/json", "Accept": "application/json"},
            success: function (data) {
                if (data.status == "success") {
            ...
            if (custno != null) {
                ...
                if (addrno == '' || addrno == null) {
                    ...
                    $.ajax({
                        ...
                        url: "http://192.168.199.242:8080/BSMD/updateUserAddress.do",
                        dataType: "json",
                        header: {"Content-Type": "application/json", "Accept": "application/json"},
                        success: function (data) {
