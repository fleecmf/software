...
function chgadcheck(pos){
    ...
    if(custno!=null&custno!=""){
        ...
        $.ajax({
            type: "post",
            url: "http://192.168.199.242:8080/BSMD/car/isOnArea.do",
...
function loadItem() {
    ...
    if(name!=null&&name!=""){
        ...
        $.ajax({
            type: "post",
             url: "http://192.168.199.242:8080/BSMD/car/showCar.do",
            data:JSON.stringify(x),
            dataType: "json",
            header: {
                "Content-Type": "application/json",
            ...
            success: function (data) {
                ...
                if(json!=null){
                    ...
                    for(var i=0;i<json.cartList.length;i++){
                        ...
                        html+='<div class="col-lg-1 favorite"> <a class="favorites" onclick="" pruductid="'+json.cartList[i].itemNo+'" href="">移入收藏</a><br/> ';
                        html+='<a class="items-delete" num="1" productid="'+json.cartList[i].barcode+'"href="javascript:;">删除</a> </div></li><div class="_none notsell">商品此地区无货，您还可以选择其他商品</div>';
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.result=="success"){
                        ...
                        var notstock= $(this).parent().parent().prev().prev();
       ...
       var name=isload();
        if(name!=""&&name!=null){
            ...
            $.ajax({
                ...
                data:JSON.stringify(x),
                dataType:"json",
                url:"http://192.168.199.242:8080/BSMD/car/isOverStock.do",
                header: {
                    "Content-Type": "application/json",
                    "Accept": "application/json"
                },
